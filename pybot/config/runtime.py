...
def hunt_runtime_config_from_settings(
    ...
    *,
    ...
    return HuntRuntimeConfig(
        ...
        skill_timer_button=settings.skill_timer_button,
        skill_timer_scan_code=key_name_to_scan_code(settings.skill_timer_button),
        skill_timer_interval_ms=settings.skill_timer_interval * 1000,
