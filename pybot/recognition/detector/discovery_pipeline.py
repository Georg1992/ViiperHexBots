...
DISCOVERY_PIPELINE: tuple[PipelineStage, ...] = (
    ...
    PipelineStage(
        ...
        items=(
            ...
            "pre-shrink extract: same min-area + aspect band as heat (fail-closed; GRF widens band via grfAspectBandScale)",
            ...
            "dual gate recall AND precision (mode-aware: GRF relaxed via silhouette_gate_thresholds)",
