...
SIMPLE_DIR = Path(__file__).resolve().parent
MOB_REC_DIR = SIMPLE_DIR.parent
PROJECT_ROOT = MOB_REC_DIR.parent
for path in (str(SIMPLE_DIR), str(MOB_REC_DIR)):
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--fixtures", default=str(MOB_REC_DIR / "test-fixtures"))
